...
* **Feature Subsampling:** Tại mỗi nút phân tách của cây con, số lượng đặc trưng đưa vào cân nhắc được giới hạn ngẫu nhiên theo tỷ lệ căn bậc hai ($\sqrt{\text{n\_features}}$), giúp tăng tính đa dạng sinh học giữa các cây.
